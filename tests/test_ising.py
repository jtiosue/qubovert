...
problem = Ising({'a': -1, 'b': 2, ('a', 'b'): -3, ('b', 'c'): -4}, -2)
...
def test_ising_reinitialize_dictionary():
    ...
    d = Ising({0: 1, (1, 0): 2, (2, 0): 0, (0, 1): 1})
    assert d == {0: 1, (0, 1): 1, (1, 0): 2}
...
def test_ising_update():
    ...
    assert d == {(1, 0): 1, 1: -1, (0, 1): 2}

    d = Ising({0: 1, (0, 1): 2})
    d.update(Ising({(1, 0): 1, 1: -1}, -1))
    assert d == Ising({0: 1, (0, 1): 2, (1, 0): 1, 1: -1}, -1)
