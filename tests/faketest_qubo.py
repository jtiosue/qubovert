...
def test_qubo_update():
    ...
    assert d == {(1, 0): 1, (1, 1): -1, (0, 1): 2}

    d = QUBO({(0, 0): 1, (0, 1): 2})
    d.update(QUBO({(1, 0): 1, (1, 1): -1}, -1))
    assert d == QUBO({0: 1, (0, 1): 2, (1, 0): 1, (1, 1): -1}, -1)
